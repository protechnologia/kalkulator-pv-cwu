...
Otwórz `pv-sim.v1.6.html` w przeglądarce. Nie wymaga żadnej instalacji ani serwera.

## Struktura plików

```
pv-sim.v1.6.html      — jedyna strona HTML; ładuje CSS i JS w odpowiedniej kolejności
