...
Otwórz `pv-sim.v1.7.html` w przeglądarce. Nie wymaga żadnej instalacji ani serwera.

## Struktura plików

```
pv-sim.v1.7.html      — jedyna strona HTML; ładuje CSS i JS w odpowiedniej kolejności
