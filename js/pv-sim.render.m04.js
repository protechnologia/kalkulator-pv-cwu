...
(function(P) {
  ...
  P.renderTankStats = function(simTank) {
    ...
    const _Qcirc_d = simTank.daily.Q_circ || 0;
    document.getElementById('pvsim-bilans-tap').textContent      = 'w tym ' + P.fmt.pl1(Math.max(simTank.daily.Q_saved - _Qcirc_d, 0));
    document.getElementById('pvsim-bilans-circ').textContent     = 'w tym ' + P.fmt.pl1(_Qcirc_d);
