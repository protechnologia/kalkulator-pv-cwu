...
(function(P) {
  ...
  P.renderMonthStats = function(simMonth) {
    ...
    const _Qcirc_m = mo.Q_circ || 0;
    set('w tym ' + P.fmt.pl0(Math.max(mo.Q_saved - _Qcirc_m, 0)), 'pvsim-month-bilans-tap');
    set('w tym ' + P.fmt.pl0(_Qcirc_m),         'pvsim-month-bilans-circ');
